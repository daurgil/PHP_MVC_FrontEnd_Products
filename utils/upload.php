...
///////////////
    ...
    $upfile = ($_SERVER['DOCUMENT_ROOT'] . '/php_mvc_products/media/'.$_FILES['file']['name']);
...
function remove_files(){
	...
	//$name = $_POST["filename"];
	if(file_exists($_SERVER['DOCUMENT_ROOT'] . '/php_mvc_products/media/'.$_SESSION['nombreFichero'])){
		unlink($_SERVER['DOCUMENT_ROOT'] . '/php_mvc_products/media/'.$_SESSION['nombreFichero']);
		return true;
	}else{
		return false;
	}
