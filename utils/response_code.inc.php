...
function showErrorPage($code = 0, $message = "", $http = "", $num_http = 0) {
    switch ($code) {
        ...
        case 2:
            ...
            $log->add_log_product($message, "", "", "response " . http_response_code()); //$msg, $username = "", $controller, $function
...
function ErrorHandler($errno, $errstr, $errfile, $errline) {
    ...
    $log->add_log_product($msg, "", $_SESSION['module'], "response " . http_response_code()); //$msg, $username = "", $controller, $function
}
